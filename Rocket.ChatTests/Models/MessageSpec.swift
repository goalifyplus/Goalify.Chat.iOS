...
extension MessageSpec {
    ...
    func testQuoteString() {
        ...
        message.subscription.type = .channel
        XCTAssertEqual(message.quoteString, " [ ](https://public.goalify.chat/channel/subscription-name?msg=message-identifier)", "channel quoteString is correct")
        message.subscription.type = .group
        XCTAssertEqual(message.quoteString, " [ ](https://public.goalify.chat/group/subscription-name?msg=message-identifier)", "group quoteString is correct")
        message.subscription.type = .directMessage
        XCTAssertEqual(message.quoteString, " [ ](https://public.goalify.chat/direct/subscription-name?msg=message-identifier)", "dm quoteString is correct")
    ...
    func testReplyString() {
        ...
        message.subscription.type = .channel
        XCTAssertEqual(message.replyString, " @user-username [ ](https://public.goalify.chat/channel/subscription-name?msg=message-identifier)", "channel replyString is correct")
        message.subscription.type = .group
        XCTAssertEqual(message.replyString, " @user-username [ ](https://public.goalify.chat/group/subscription-name?msg=message-identifier)", "group replyString is correct")
        message.subscription.type = .directMessage
        XCTAssertEqual(message.replyString, " [ ](https://public.goalify.chat/direct/subscription-name?msg=message-identifier)", "dm replyString is correct")
