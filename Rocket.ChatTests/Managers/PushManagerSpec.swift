...
extension PushNotification {
    static func testRaw() -> [AnyHashable: Any] {
        return  [
            ...
            "ejson": "{\"host\":\"https://nau.goalify.chat/\",\"rid\":\"9euspXGgYsbEE5hi8\",\"sender\":{\"_id\":\"iBENea3v3cbD7RTry\",\"username\":\"johnny.appleseed\",\"name\":\"Johnny Appleseed\"},\"type\":\"c\",\"name\":\"general\"}",
            "messageFrom": "push"
        ] as [AnyHashable: Any]
    }
...
class PushNotificationSpec: XCTestCase {
    func testInit() {
        ...
        XCTAssertEqual(notification?.host, "https://nau.goalify.chat/")
    }
}
