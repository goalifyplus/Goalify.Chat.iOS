...
class URLExtensionSpec: XCTestCase {
    ...
    func testInitWithStringAndScheme() {
        XCTAssertEqual(URL(string: "open.rocket.chat", scheme: "https")?.absoluteString, "https://public.goalify.chat", "will add scheme")
        XCTAssertEqual(URL(string: "https://public.goalify.chat", scheme: "https")?.absoluteString, "https://public.goalify.chat", "will return correct url")
        XCTAssertEqual(URL(string: "http://open.rocket.chat", scheme: "https")?.absoluteString, "https://public.goalify.chat", "will force https scheme")
        XCTAssertEqual(URL(string: "https://public.goalify.chat", scheme: "wss")?.absoluteString, "wss://open.rocket.chat", "will force wss scheme")
        XCTAssertEqual(URL(string: "http://open.rocket.chat/path", scheme: "https")?.absoluteString, "https://public.goalify.chat/path", "will keep path")
        XCTAssertEqual(URL(string: "http://open.rocket.chat?query=test", scheme: "https")?.absoluteString, "https://public.goalify.chat?query=test", "will keep query")
        XCTAssertEqual(URL(string: "http://open.rocket.chat/path?query=test", scheme: "https")?.absoluteString, "https://public.goalify.chat/path?query=test", "will keep path & query")
        XCTAssertEqual(URL(string: "http://open.rocket.chat:3000/path?query=test", scheme: "https")?.absoluteString, "https://public.goalify.chat:3000/path?query=test", "will keep path & query & port")
    ...
    func testQueryParameters() {
        let testURL: URL! = URL(string: "https://public.goalify.chat/?query1=test1&query2=test2")
        ...
        let testURL2: URL! = URL(string: "https://public.goalify.chat/")
